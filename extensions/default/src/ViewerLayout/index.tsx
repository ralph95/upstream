...
const resizableHandleClassName = 'mt-[1px] bg-[rgb(var(--background))]';
...
function ViewerLayout({
  ...
  return (
    <div>
      ...
      />
      <div
        className="relative flex w-full flex-row flex-nowrap items-stretch overflow-hidden bg-[rgb(var(--background))]"
          ...
          <ResizablePanelGroup {...resizablePanelGroupProps}>
            ...
            <ResizablePanel {...resizableViewportGridPanelProps}>
              <div className="flex h-full flex-1 flex-col">
                <div
                  className="relative flex h-full flex-1 items-center justify-center overflow-hidden bg-[rgb(var(--background))]"
