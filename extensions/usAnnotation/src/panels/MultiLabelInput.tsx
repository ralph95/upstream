    ...
    <div>
      ...
      <div className="flex flex-wrap">
        {internalLabels.map((label, index) => (
          <span
            key={index}
            className="m-1 inline-flex items-center rounded-full bg-[#2a2a4a] px-4 py-1 text-[rgb(var(--text))]"
          >
            {label}
            <button
              className="ml-2.5 cursor-pointer rounded-full bg-blue-800 px-2 py-0.5 text-xs text-[rgb(var(--text))] transition-colors hover:bg-blue-600"
