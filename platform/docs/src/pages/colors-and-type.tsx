...
function ShowcaseRow({ title, description, children, code }: ShowcaseRowProps) {
  ...
  return (
    <div className="bg-background mb-8 rounded-lg p-6">
      ...
      {showCode && (
        <pre className="border-input mt-4 overflow-x-auto rounded-md border bg-[rgb(var(--background))] p-4 text-sm">
          <code>{code}</code>
        </pre>
      )}
    </div>
...
//       {showCode && (
//         <pre className="mt-4 overflow-x-auto rounded-md bg-[rgb(var(--background))] p-4 text-sm">
//           <code>{code}</code>
//         </pre>
//       )}
//     </div>
