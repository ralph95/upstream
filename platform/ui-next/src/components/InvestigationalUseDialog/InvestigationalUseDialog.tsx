...
const InvestigationalUseDialog = ({
  ...
  return (
    <div className="fixed bottom-2 z-50 flex h-[86px] w-full justify-center">
      <div className="border-primary-dark flex w-[90%] items-center justify-between rounded-lg border-2 bg-[rgb(var(--secondary-dark))] pl-[22px] pr-[22px] pt-[10px] pb-[10px] shadow-lg">
        <div className="flex items-center gap-4">
          <Icons.InvestigationalUse className="h-18 w-18" />
          <div className="flex flex-col">
            <div className="text-[19px] text-[rgb(var(--text))]">
              OHIF Viewer is{' '}
              <span className="text-primary-light">{t('for investigational use only')}</span>
            </div>
            <div className="text-[13px] text-[rgb(var(--text))]">
              <span
