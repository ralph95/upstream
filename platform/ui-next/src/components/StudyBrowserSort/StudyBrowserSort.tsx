      ...
      <DropdownMenu>
        <Tooltip>
          <TooltipTrigger className="w-full overflow-hidden">
            <DropdownMenuTrigger className="border-inputfield-main focus:border-inputfield-main flex h-[26px] w-full items-center justify-start overflow-hidden whitespace-nowrap rounded border bg-[rgb(var(--background))] p-2 text-base text-[rgb(var(--text))]">
              {selectedSort.label}
            </DropdownMenuTrigger>
          </TooltipTrigger>
      ...
      <Tooltip>
        <TooltipTrigger>
          <button
            ...
            className="flex h-[26px] items-center justify-center bg-[rgb(var(--background))]"
          >
