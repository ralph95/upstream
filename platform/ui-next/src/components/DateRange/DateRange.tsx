      ...
      <Popover.Popover>
        <Popover.PopoverTrigger asChild>
          <div className="relative w-full">
            <CalendarIcon className="absolute right-2 top-1/2 h-4 w-4 -translate-y-1/2 transform text-[rgb(var(--text))]" />
            <input
              id={`${id}-start`}
              type="text"
              ...
              className={cn(
                'border-inputfield-main focus:border-inputfield-focus h-[32px] w-full justify-start rounded border bg-[rgb(var(--background))] py-[6.5px] pl-[6.5px] pr-[6.5px] text-left text-base font-normal hover:bg-[rgb(var(--background))] hover:text-[rgb(var(--text))]',
        ...
        <Popover.PopoverTrigger asChild>
          <div className="relative w-full">
            ...
            <input
              ...
              className={cn(
                'border-inputfield-main focus:border-inputfield-focus h-full w-full justify-start rounded border bg-[rgb(var(--background))] py-[6.5px] pl-[6.5px] pr-[6.5px] text-left text-base font-normal hover:bg-[rgb(var(--background))] hover:text-[rgb(var(--text))]',
